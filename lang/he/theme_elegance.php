...
$string['mydashboard'] = 'עדכונים בקורסים שלי';
...
$string['prelogincontenten'] = 'Content on log-in page - English';
$string['prelogincontentendesc'] = 'Entered text will appear on English log-in page.';

$string['prelogincontenthe'] = 'Content on log-in page - Hebrew';
$string['prelogincontenthedesc'] = 'Entered text will appear on Hebrew log-in page.';

$string['prelogincontentdefaultlang'] = 'Default language for log-in page content';
$string['prelogincontentdefaultlangdesc'] = 'Select which message - Hebrew or English - will appear if a language other than Hebrew or English is selected.';
...
$string['hidehelp'] = 'Hide help link';
$string['hidehelpdesc'] = 'If checked the "Moodle Docs for this page" link at the bottom of certain pages, will not appear.';

$string['hideloggedin'] = 'Hide logged-in';
$string['hideloggedindesc'] = 'If checked the "You are logged in as" message and the "log-out" link at the bottom of all pages, will not appear.';
...
$string['logossettings'] = 'Footer Logos Settings';
$string['logossettingssub'] = 'These settings control the logos that appear on the footer of every page';
$string['logossettingsdesc'] = 'Enable and determine settings for each logo below';


$string['logosindicator'] = 'Logo Number ';
$string['logosindicatordesc'] = 'Set up this logo';

$string['logospeed'] = 'Logo Duration ';
$string['logospeeddesc'] = 'Set how long the logo appears in milliseconds';


$string['logonumber'] = 'Number of logos ';
$string['logonumberdesc'] = 'Number of logo options will change as soon you change this option';

$string['enablelogos'] = 'Enable this Logo';
$string['enablelogosdesc'] = 'Will you be using this logo';

$string['logostitle'] = 'Logo Title';
$string['logostitledesc'] = 'Text that will appear if image does not load (e.g. non-graphic browser or due to communication errors), and also text that will appear when the mouse is hovered over the image';

$string['logostext'] = 'Logo Text';
$string['logostextdesc'] = 'Text to display on the logo';

$string['logoslinktext'] = 'URL Name';
$string['logoslinktextdesc'] = 'Text to display when showing link';

$string['logoslinkurl'] = 'URL Address';
$string['logoslinkurldesc'] = 'Address logo links to';

$string['logosimage'] = 'Logo Image';
$string['logosimagedesc'] = 'Large image to go behind the logo text';

$string['logoscolor'] = 'Logo Colour';
$string['logoscolordesc'] = 'Don\'t want to use an image? Specify a background colour instead';
